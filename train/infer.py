...
bs = 1
output_path = f"../output/zui/qwen3-4b-ft-valb{'_val' if 'val' in val_data_path else ''}.json"

model = AutoModelForCausalLM.from_pretrained("/workspace/cache/test-data-train/x/models/zui-Qwen3-4B-ft-full-2048左截断-valb/checkpoint-2490").to('cuda:0')
